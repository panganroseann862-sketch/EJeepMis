...
class StoreEjeepRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'vehicle_number' => 'required|string|max:50|unique:ejeeps,vehicle_number',
            'plate_number' => 'required|string|max:20|unique:ejeeps,plate_number',
