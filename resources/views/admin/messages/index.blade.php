            ...
            <div class="overflow-y-auto" style="max-height: 600px;">
                ...
                @empty
                    <div class="p-8 text-center text-gray-500">
                        ...
                        <p class="text-sm mt-2">Start a new conversation with a driver</p>
                    </div>
                @endforelse
            </div>
        </div>
...
<div id="new-conversation-modal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 max-w-md w-full mx-4">
        ...
        <form action="{{ route('admin.messages.send') }}" method="POST">
            @csrf
            <div class="mb-4">
                <label class="block text-gray-700 font-medium mb-2">Select Driver</label>
...
@if(isset($openConversation) && $openConversation)
...
function loadConversation(conversationId, driverId, driverName) {
    currentConversationId = conversationId;
    currentDriverId = driverId;
    
    document.getElementById('chat-recipient-name').textContent = driverName;
...
function fetchMessages() {
    ...
    fetch(`/admin/messages/conversation/${currentConversationId}`, {
        headers: {
